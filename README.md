...
For more information, see [METS Validation documentation](/docs/METS Validation.txt).
...
For more information, see [BEXT Validation documentation](/docs/BEXT Validation.txt).
